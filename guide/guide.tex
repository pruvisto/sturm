...
Using this reduction, the \sturm\ method can also decide single \enquote{less than}/\enquote{ŋreater than} inequalities of the form 
...
\begin{enumerate}
\item ensure that your function is indeed a \emph{real} polynomial. Add a type annotation to \emph{real} if necessary.
